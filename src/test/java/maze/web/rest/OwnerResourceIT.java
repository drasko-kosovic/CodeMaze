...
import maze.IntegrationTest;
import maze.domain.Owner;
import maze.repository.OwnerRepository;
...
class OwnerResourceIT {
    ...
    private static final LocalDate DEFAULT_DATE_OF_BIRT = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_OF_BIRT = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Owner createEntity(EntityManager em) {
        Owner owner = new Owner().name(DEFAULT_NAME).dateOfBirt(DEFAULT_DATE_OF_BIRT).address(DEFAULT_ADDRESS);
        return owner;
    }
    ...
    public static Owner createUpdatedEntity(EntityManager em) {
        Owner owner = new Owner().name(UPDATED_NAME).dateOfBirt(UPDATED_DATE_OF_BIRT).address(UPDATED_ADDRESS);
        return owner;
    }
    ...
    void createOwner() throws Exception {
        ...
        assertThat(testOwner.getDateOfBirt()).isEqualTo(DEFAULT_DATE_OF_BIRT);
    ...
    void getAllOwners() throws Exception {
        ...
        restOwnerMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateOfBirt").value(hasItem(DEFAULT_DATE_OF_BIRT.toString())))
    ...
    void getOwner() throws Exception {
        ...
        restOwnerMockMvc
            ...
            .andExpect(jsonPath("$.dateOfBirt").value(DEFAULT_DATE_OF_BIRT.toString()))
    ...
    void putNewOwner() throws Exception {
        ...
        updatedOwner.name(UPDATED_NAME).dateOfBirt(UPDATED_DATE_OF_BIRT).address(UPDATED_ADDRESS);
        ...
        assertThat(testOwner.getDateOfBirt()).isEqualTo(UPDATED_DATE_OF_BIRT);
    ...
    void partialUpdateOwnerWithPatch() throws Exception {
        ...
        partialUpdatedOwner.dateOfBirt(UPDATED_DATE_OF_BIRT);
    ...
    void fullUpdateOwnerWithPatch() throws Exception {
        ...
        partialUpdatedOwner.name(UPDATED_NAME).dateOfBirt(UPDATED_DATE_OF_BIRT).address(UPDATED_ADDRESS);
